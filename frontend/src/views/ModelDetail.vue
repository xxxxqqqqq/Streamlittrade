...
interface MetricCard{label:string;value:number|null|undefined;mode?:'rate'|'ratio';digits?:number;tone?:boolean}
const metricCards=computed<MetricCard[]>(()=>[
  {label:'ROC AUC',value:metrics.value.roc_auc},
  {label:'Rank IC',value:metrics.value.rank_ic,mode:'ratio',digits:3},
  {label:'成本后收益',value:metrics.value.cost_adjusted_return,tone:true},
  {label:'超额收益',value:metrics.value.excess_return,tone:true},
  {label:'年化夏普',value:metrics.value.annualized_sharpe,mode:'ratio',digits:3},
  {label:'换手率',value:metrics.value.turnover},
])
