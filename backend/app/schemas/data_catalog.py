...
class FactorLibraryItem(BaseModel):
    implementation:str;name:str;family:str;description:str;default_window:int
class MaterializeCreate(BaseModel):
    name:str=Field(min_length=2,max_length=120);data_version_id:UUID;feature_definition_ids:list[UUID]=Field(min_length=1,max_length=100)
